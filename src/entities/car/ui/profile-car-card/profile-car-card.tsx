...
export const ProfileCarCard: FCWithChildren<ProfileCarCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          `w-full pl-small pr-3 border border-transparent hover:border-black py-small main:py-1.5 main:pl-1.5 main:gap-5 grid grid-cols-4 gap-small max-w-[335px]
      ...
      >
        <div className='relative border-none shrink-0 !w-[76px] h-[76px] main:!w-16 main:h-16 rounded-xl transition-colors'>
          {loading ? (
            ...
            <NextImage src={car?.images[0]?.pathS3} photoPlugCar className='absolute rounded-xl ' />
          )}
        </div>
